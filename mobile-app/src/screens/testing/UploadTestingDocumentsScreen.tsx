...
const UploadTestingDocumentsScreen: React.FC = () => {
  ...
  const { productName, modelNumber, description, tests } = route.params || {};
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          <Text style={styles.headerTitle}>Upload Test Specs</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Upload any technical specifications you already have. These are optional here and can be requested later.
          </Text>
        </View>
        ...
        >
          ...
          <Text style={styles.termsText}>
            I confirm that these technical specifications are accurate and belong to the product to be tested.
          </Text>
        </TouchableOpacity>
      ...
      <View style={[styles.stickyFooter, { paddingBottom: Math.max(insets.bottom, 16) }]}>
        <Button
          title="Proceed to Lab Selection"
          onPress={handleNext}
          disabled={!agreed}
          fullWidth
          size="lg"
...
export default UploadTestingDocumentsScreen;
