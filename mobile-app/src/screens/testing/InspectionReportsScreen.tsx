...
const InspectionReportsScreen: React.FC = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.addBtn} onPress={() => navigation.navigate('NewInspection')}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={[styles.card, Shadows.sm]}>
          <LinearGradient colors={isDark ? [colors.bgCard, colors.bgCardLight] : ['#FFFFFF','#F7F8FC']} style={styles.cardInner}>
            ...
            <Text style={styles.title}>InspectionReports</Text>
...
const makeStyles = (colors: ReturnType<typeof useTheme>['colors'], isDark: boolean) => StyleSheet.create({
  ...
  addBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: isDark ? 'rgba(108, 99, 255, 0.1)' : '#F0EFFF', alignItems: 'center', justifyContent: 'center' },
...
export default InspectionReportsScreen;
