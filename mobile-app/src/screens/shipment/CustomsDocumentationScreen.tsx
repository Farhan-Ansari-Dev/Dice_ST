...
const CustomsDocumentationScreen: React.FC = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>CustomsDocumentation</Text>
        <View style={{ width: 40 }} />
      </View>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={[styles.card, Shadows.sm]}>
          <LinearGradient colors={isDark ? [colors.bgCard, colors.bgCardLight] : ['#FFFFFF','#F7F8FC']} style={styles.cardInner}>
            <Ionicons name="boat-outline" size={40} color={colors.primary} style={{ alignSelf: 'center', marginBottom: 12 }} />
            <Text style={styles.title}>CustomsDocumentation</Text>
            <Text style={styles.subtitle}>Shipment compliance and documentation details for SCS-SHIP-2024-0042</Text>
          </LinearGradient>
        </View>
...
export default CustomsDocumentationScreen;
