...
const INTL_CERTS: any[] = [];

const InternationalCertificationsScreen: React.FC = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>International Certifications</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState icon="globe-outline" title="No International Certifications" subtitle="Apply for international compliance." />
        }
        refreshControl={
...
const makeStyles = (colors: ReturnType<typeof useTheme>['colors'], isDark: boolean) =>
  StyleSheet.create({
    ...
    countryRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
    countryText: { fontSize: 12, color: colors.textSecondary },
  });

export default InternationalCertificationsScreen;
