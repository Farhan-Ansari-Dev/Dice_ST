...
const ComplianceOverviewScreen: React.FC = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>ComplianceOverview</Text>
        <View style={{ width: 40 }} />
      </View>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={[styles.card, Shadows.sm]}>
          <LinearGradient colors={isDark ? [colors.bgCard, colors.bgCardLight] : ['#FFFFFF','#F7F8FC']} style={styles.cardInner}>
            <Ionicons name="analytics-outline" size={40} color={colors.primary} style={{ alignSelf: 'center', marginBottom: 12 }} />
            <Text style={styles.title}>ComplianceOverview</Text>
            <Text style={styles.subtitle}>Detailed compliance analytics and status overview for Sanyog Conformity Solutions.</Text>
          </LinearGradient>
        </View>
...
export default ComplianceOverviewScreen;
