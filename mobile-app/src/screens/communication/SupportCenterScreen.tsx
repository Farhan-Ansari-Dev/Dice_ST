...
const makeStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  tabContainer: { flexDirection: 'row', marginHorizontal: 16, backgroundColor: colors.bgCard, borderRadius: 24, padding: 4, marginBottom: 16 },
  ...
  contactCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.bgCard, padding: 16, borderRadius: 16, marginBottom: 12 },
  ...
  actionCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.bgCard, padding: 16, borderRadius: 12, marginBottom: 12 },
