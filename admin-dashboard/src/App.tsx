...
const MeetingRequestsPage = lazy(() => import('./pages/consultants/MeetingRequestsPage'))
const PartnerApplicationsPage = lazy(() => import('./pages/partners/PartnerApplicationsPage'))
